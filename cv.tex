...
\cvline{Grants}%
{\small 
\textbf{PI} of Etown Summer Schloarship, Creative Arts and Research Projects Grants, 2019, 2020, and 2021 (\$6,200, \$9,440, \$9,640); \newline
...
{\small \href{https://scholar.google.com/citations?user=wFIBx94AAAAJ&hl}
  {\color{color2}\homepagesymbol~(Google Scholar)}: 223}
%
\cvline{$h$-index}%
{\small \href{https://scholar.google.com/citations?user=wFIBx94AAAAJ&hl}
  {\color{color2}\homepagesymbol~(Google Scholar)}: 7}
...
Amount: sub-awarded \$15,000 out of \$499,999.00
}
...
{\textbf{Co-PI}: CICI: RSARC: \textit{SECTOR: Building a {SE}cure and Compliant {C}yberinfrastructure for {T}ranslati{o}nal {R}esearch.} \newline
	...
	Year: 2017-2021 \newline
	Amount:  sub-awarded \$80,000 out of \$999,651.00
}
\cvline{NSF I-Corps}%
...
\cvline{Committee}{15th IEEE International Conference on Networking, Architecture, and Storage (NAS'2020)}%
